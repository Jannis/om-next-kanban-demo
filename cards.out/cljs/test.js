...
var args20293 = [];
var len__6152__auto___20297 = arguments.length;
var i__6153__auto___20298 = (0);
while(true){
if((i__6153__auto___20298 < len__6152__auto___20297)){
args20293.push((arguments[i__6153__auto___20298]));

var G__20299 = (i__6153__auto___20298 + (1));
i__6153__auto___20298 = G__20299;
continue;
} else {
}
break;
...
var G__20296__$1 = ((cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter))?cljs.core.assoc.call(null,G__20296,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint):G__20296);
return G__20296__$1;
});
...
var len__6152__auto___20304 = arguments.length;
var i__6153__auto___20305 = (0);
while(true){
if((i__6153__auto___20305 < len__6152__auto___20304)){
args__6159__auto__.push((arguments[i__6153__auto___20305]));

var G__20306 = (i__6153__auto___20305 + (1));
i__6153__auto___20305 = G__20306;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq20301){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__20302,G__20303,seq20301__$2);
});
...
var file = cljs.core.get.call(null,map__20310__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__20310__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__20310__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__20310,map__20310__$1,file,line,column){
return (function (p1__20307_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__20307_SHARP_));
});})(map__20310,map__20310__$1,file,line,column))
...
var temp__4425__auto___20314 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___20314)){
var message_20315 = temp__4425__auto___20314;
cljs.core.println.call(null,message_20315);
} else {
}
...
var G__20321 = exception.stack;
var G__20321__$1 = (((G__20321 == null))?null:clojure.string.split_lines.call(null,G__20321));
var G__20321__$2 = (((G__20321__$1 == null))?null:cljs.core.get.call(null,G__20321__$1,depth));
var G__20321__$3 = (((G__20321__$2 == null))?null:clojure.string.trim.call(null,G__20321__$2));
return G__20321__$3;
} else {
...
var vec__20322 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__20322,(0),null);
var column = cljs.core.nth.call(null,vec__20322,(1),null);
var vec__20323 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__20323,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__20323,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__20323,(2),null);
...
var m__$1 = (function (){var G__20325 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__20325) {
case "fail":
...
var G__20331 = (function (){var G__20330 = cljs.core.rest.call(null,fns);
var G__20330__$1 = (cljs.core.truth_(new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,obj)))?cljs.core.concat.call(null,obj,G__20330):G__20330);
return G__20330__$1;
})();
fns = G__20331;
continue;
...
var G__20333 = fns;
var G__20333__$1 = (((G__20333 == null))?null:cljs.core.vary_meta.call(null,G__20333,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true));
return G__20333__$1;
});
...
}catch (e20336){var e = e20336;
var G__20337 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__20337) {
...
var vec__20340 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__20340,(0),null);
var types = vec__20340;
...
return cljs.core.map.call(null,(function (p__20348){
var vec__20349 = p__20348;
var ns = cljs.core.nth.call(null,vec__20349,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__20349,(1),null);
return ((function (vec__20349,ns,vars__$1){
return (function (){
...
var G__20350 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__20350) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__20350,env,once_fixtures,each_fixtures,vec__20349,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__20350,env,once_fixtures,each_fixtures,vec__20349,ns,vars__$1){
return (function (){
var seq__20351 = cljs.core.seq.call(null,vars__$1);
var chunk__20352 = null;
var count__20353 = (0);
var i__20354 = (0);
while(true){
if((i__20354 < count__20353)){
var v = cljs.core._nth.call(null,chunk__20352,i__20354);
var temp__4425__auto___20356 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___20356)){
var t_20357 = temp__4425__auto___20356;
each_fixture_fn.call(null,((function (seq__20351,chunk__20352,count__20353,i__20354,t_20357,temp__4425__auto___20356,v,each_fixture_fn,G__20350,env,once_fixtures,each_fixtures,vec__20349,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20357)));
});})(seq__20351,chunk__20352,count__20353,i__20354,t_20357,temp__4425__auto___20356,v,each_fixture_fn,G__20350,env,once_fixtures,each_fixtures,vec__20349,ns,vars__$1))
);
} else {
}

var G__20358 = seq__20351;
var G__20359 = chunk__20352;
var G__20360 = count__20353;
var G__20361 = (i__20354 + (1));
seq__20351 = G__20358;
chunk__20352 = G__20359;
count__20353 = G__20360;
i__20354 = G__20361;
continue;
} else {
var temp__4425__auto__ = cljs.core.seq.call(null,seq__20351);
if(temp__4425__auto__){
var seq__20351__$1 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__20351__$1)){
var c__5897__auto__ = cljs.core.chunk_first.call(null,seq__20351__$1);
var G__20362 = cljs.core.chunk_rest.call(null,seq__20351__$1);
var G__20363 = c__5897__auto__;
var G__20364 = cljs.core.count.call(null,c__5897__auto__);
var G__20365 = (0);
seq__20351 = G__20362;
chunk__20352 = G__20363;
count__20353 = G__20364;
i__20354 = G__20365;
continue;
} else {
var v = cljs.core.first.call(null,seq__20351__$1);
var temp__4425__auto___20366__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___20366__$1)){
var t_20367 = temp__4425__auto___20366__$1;
each_fixture_fn.call(null,((function (seq__20351,chunk__20352,count__20353,i__20354,t_20367,temp__4425__auto___20366__$1,v,seq__20351__$1,temp__4425__auto__,each_fixture_fn,G__20350,env,once_fixtures,each_fixtures,vec__20349,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20367)));
});})(seq__20351,chunk__20352,count__20353,i__20354,t_20367,temp__4425__auto___20366__$1,v,seq__20351__$1,temp__4425__auto__,each_fixture_fn,G__20350,env,once_fixtures,each_fixtures,vec__20349,ns,vars__$1))
);
} else {
}

var G__20368 = cljs.core.next.call(null,seq__20351__$1);
var G__20369 = null;
var G__20370 = (0);
var G__20371 = (0);
seq__20351 = G__20368;
chunk__20352 = G__20369;
count__20353 = G__20370;
i__20354 = G__20371;
continue;
}
} else {
...
});})(each_fixture_fn,G__20350,env,once_fixtures,each_fixtures,vec__20349,ns,vars__$1))
);
});})(each_fixture_fn,G__20350,env,once_fixtures,each_fixtures,vec__20349,ns,vars__$1))
], null);
