...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__15519,opts){
var map__15520 = p__15519;
var map__15520__$1 = ((((!((map__15520 == null)))?((((map__15520.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15520.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15520):map__15520);
var files = cljs.core.get.call(null,map__15520__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6152__auto___15526 = arguments.length;
var i__6153__auto___15527 = (0);
while(true){
if((i__6153__auto___15527 < len__6152__auto___15526)){
args__6159__auto__.push((arguments[i__6153__auto___15527]));

var G__15528 = (i__6153__auto___15527 + (1));
i__6153__auto___15527 = G__15528;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__15524){
var vec__15525 = p__15524;
var opts = cljs.core.nth.call(null,vec__15525,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__15525,opts){
return (function (evt){
...
});})(conn,vec__15525,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__15525,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__15525,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__15525,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq15522){
var G__15523 = cljs.core.first.call(null,seq15522);
var seq15522__$1 = cljs.core.next.call(null,seq15522);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__15523,seq15522__$1);
});
