...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__15372,opts){
var map__15373 = p__15372;
var map__15373__$1 = ((((!((map__15373 == null)))?((((map__15373.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15373.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15373):map__15373);
...
var len__6152__auto___15379 = arguments.length;
var i__6153__auto___15380 = (0);
while(true){
if((i__6153__auto___15380 < len__6152__auto___15379)){
args__6159__auto__.push((arguments[i__6153__auto___15380]));

var G__15381 = (i__6153__auto___15380 + (1));
i__6153__auto___15380 = G__15381;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__15377){
var vec__15378 = p__15377;
var opts = cljs.core.nth.call(null,vec__15378,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__15378,opts){
return (function (evt){
...
});})(conn,vec__15378,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__15378,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__15378,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__15378,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq15375){
var G__15376 = cljs.core.first.call(null,seq15375);
var seq15375__$1 = cljs.core.next.call(null,seq15375);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__15376,seq15375__$1);
});
