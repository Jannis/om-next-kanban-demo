...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__16976,opts){
var map__16977 = p__16976;
var map__16977__$1 = ((((!((map__16977 == null)))?((((map__16977.cljs$lang$protocol_mask$partition0$ & (64))) || (map__16977.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16977):map__16977);
var files = cljs.core.get.call(null,map__16977__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6226__auto___16983 = arguments.length;
var i__6227__auto___16984 = (0);
while(true){
if((i__6227__auto___16984 < len__6226__auto___16983)){
args__6233__auto__.push((arguments[i__6227__auto___16984]));

var G__16985 = (i__6227__auto___16984 + (1));
i__6227__auto___16984 = G__16985;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__16981){
var vec__16982 = p__16981;
var opts = cljs.core.nth.call(null,vec__16982,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__16982,opts){
return (function (evt){
...
});})(conn,vec__16982,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__16982,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__16982,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__16982,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq16979){
var G__16980 = cljs.core.first.call(null,seq16979);
var seq16979__$1 = cljs.core.next.call(null,seq16979);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__16980,seq16979__$1);
});
