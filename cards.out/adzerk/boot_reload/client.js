...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__15625,opts){
var map__15626 = p__15625;
...
var files = cljs.core.get.call(null,map__15626__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6152__auto___15632 = arguments.length;
var i__6153__auto___15633 = (0);
while(true){
if((i__6153__auto___15633 < len__6152__auto___15632)){
args__6159__auto__.push((arguments[i__6153__auto___15633]));

var G__15634 = (i__6153__auto___15633 + (1));
i__6153__auto___15633 = G__15634;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__15630){
var vec__15631 = p__15630;
var opts = cljs.core.nth.call(null,vec__15631,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__15631,opts){
return (function (evt){
...
});})(conn,vec__15631,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__15631,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__15631,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__15631,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq15628){
var G__15629 = cljs.core.first.call(null,seq15628);
var seq15628__$1 = cljs.core.next.call(null,seq15628);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__15629,seq15628__$1);
});
