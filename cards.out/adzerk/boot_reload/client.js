...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__15534,opts){
...
var files = cljs.core.get.call(null,map__15535__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6152__auto___15541 = arguments.length;
var i__6153__auto___15542 = (0);
while(true){
if((i__6153__auto___15542 < len__6152__auto___15541)){
args__6159__auto__.push((arguments[i__6153__auto___15542]));

var G__15543 = (i__6153__auto___15542 + (1));
i__6153__auto___15542 = G__15543;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__15539){
var vec__15540 = p__15539;
var opts = cljs.core.nth.call(null,vec__15540,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__15540,opts){
return (function (evt){
...
});})(conn,vec__15540,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__15540,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__15540,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__15540,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq15537){
var G__15538 = cljs.core.first.call(null,seq15537);
var seq15537__$1 = cljs.core.next.call(null,seq15537);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__15538,seq15537__$1);
});
