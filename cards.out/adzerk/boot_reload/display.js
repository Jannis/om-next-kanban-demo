...
return (function (p__15842){
var vec__15843 = p__15842;
var attr = cljs.core.nth.call(null,vec__15843,(0),null);
...
var args15844 = [];
var len__6152__auto___15847 = arguments.length;
var i__6153__auto___15848 = (0);
while(true){
if((i__6153__auto___15848 < len__6152__auto___15847)){
args15844.push((arguments[i__6153__auto___15848]));

var G__15849 = (i__6153__auto___15848 + (1));
i__6153__auto___15848 = G__15849;
continue;
} else {
}
break;
...
var len__6152__auto___15852 = arguments.length;
var i__6153__auto___15853 = (0);
while(true){
if((i__6153__auto___15853 < len__6152__auto___15852)){
args__6159__auto__.push((arguments[i__6153__auto___15853]));

var G__15854 = (i__6153__auto___15853 + (1));
i__6153__auto___15853 = G__15854;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq15851){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq15851));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__15855){
...
var data = map__15859__$1;
var message = cljs.core.get.call(null,map__15859__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__15859__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__15859__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__15861 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__15861,goog.events.EventType.CLICK,((function (G__15861,map__15859,map__15859__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__15861,map__15859,map__15859__$1,data,message,line,file))
);

return G__15861;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__15862){
var map__15866 = p__15862;
var map__15866__$1 = ((((!((map__15866 == null)))?((((map__15866.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15866.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15866):map__15866);
var data = map__15866__$1;
var message = cljs.core.get.call(null,map__15866__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__15866__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__15866__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__15868 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str("at line "),cljs.core.str(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__15868,goog.events.EventType.CLICK,((function (G__15868,map__15866,map__15866__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__15868,map__15866,map__15866__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__15869){
var map__15873 = p__15869;
...
var messages = map__15873__$1;
var warnings = cljs.core.get.call(null,map__15873__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__15873__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__15875 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__15875,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__15875,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__15876){
var map__15879 = p__15876;
var map__15879__$1 = ((((!((map__15879 == null)))?((((map__15879.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15879.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15879):map__15879);
var messages = map__15879__$1;
var warnings = cljs.core.get.call(null,map__15879__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__15879__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__15879,map__15879__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__15879,map__15879__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__15879,map__15879__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__15879,map__15879__$1,messages,warnings,exception))
;
...
}catch (e15882){if((e15882 instanceof Error)){
var __15883 = e15882;
} else {
throw e15882;
