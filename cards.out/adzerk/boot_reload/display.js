...
var attr = cljs.core.nth.call(null,vec__8698,(0),null);
...
var args8699 = [];
var len__6226__auto___8702 = arguments.length;
var i__6227__auto___8703 = (0);
while(true){
if((i__6227__auto___8703 < len__6226__auto___8702)){
args8699.push((arguments[i__6227__auto___8703]));

var G__8704 = (i__6227__auto___8703 + (1));
i__6227__auto___8703 = G__8704;
continue;
} else {
}
break;
...
var len__6226__auto___8707 = arguments.length;
var i__6227__auto___8708 = (0);
while(true){
if((i__6227__auto___8708 < len__6226__auto___8707)){
args__6233__auto__.push((arguments[i__6227__auto___8708]));

var G__8709 = (i__6227__auto___8708 + (1));
i__6227__auto___8708 = G__8709;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq8706){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8706));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__8710){
...
var data = map__8714__$1;
var message = cljs.core.get.call(null,map__8714__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__8714__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__8714__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__8716 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__8716,goog.events.EventType.CLICK,((function (G__8716,map__8714,map__8714__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__8716,map__8714,map__8714__$1,data,message,line,file))
);

return G__8716;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__8717){
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__8724){
var map__8728 = p__8724;
var map__8728__$1 = ((((!((map__8728 == null)))?((((map__8728.cljs$lang$protocol_mask$partition0$ & (64))) || (map__8728.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8728):map__8728);
var messages = map__8728__$1;
var warnings = cljs.core.get.call(null,map__8728__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8728__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__8730 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__8730,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__8730,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__8731){
var map__8734 = p__8731;
...
var messages = map__8734__$1;
var warnings = cljs.core.get.call(null,map__8734__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8734__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__8734,map__8734__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__8734,map__8734__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__8734,map__8734__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__8734,map__8734__$1,messages,warnings,exception))
;
