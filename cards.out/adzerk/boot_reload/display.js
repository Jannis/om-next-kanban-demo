...
return (function (p__15840){
var vec__15841 = p__15840;
var attr = cljs.core.nth.call(null,vec__15841,(0),null);
...
var args15842 = [];
var len__6152__auto___15845 = arguments.length;
var i__6153__auto___15846 = (0);
while(true){
if((i__6153__auto___15846 < len__6152__auto___15845)){
args15842.push((arguments[i__6153__auto___15846]));

var G__15847 = (i__6153__auto___15846 + (1));
i__6153__auto___15846 = G__15847;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args15842.length)].join('')));
...
var len__6152__auto___15850 = arguments.length;
var i__6153__auto___15851 = (0);
while(true){
if((i__6153__auto___15851 < len__6152__auto___15850)){
args__6159__auto__.push((arguments[i__6153__auto___15851]));

var G__15852 = (i__6153__auto___15851 + (1));
i__6153__auto___15851 = G__15852;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq15849){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq15849));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__15853){
var map__15857 = p__15853;
...
var data = map__15857__$1;
var message = cljs.core.get.call(null,map__15857__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__15857__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__15857__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__15859 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__15859,goog.events.EventType.CLICK,((function (G__15859,map__15857,map__15857__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__15859,map__15857,map__15857__$1,data,message,line,file))
);

return G__15859;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__15860){
var map__15864 = p__15860;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__15867){
var map__15871 = p__15867;
...
var messages = map__15871__$1;
var warnings = cljs.core.get.call(null,map__15871__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__15871__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__15874){
var map__15877 = p__15874;
var map__15877__$1 = ((((!((map__15877 == null)))?((((map__15877.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15877.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15877):map__15877);
var messages = map__15877__$1;
var warnings = cljs.core.get.call(null,map__15877__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__15877__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__15877,map__15877__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__15877,map__15877__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__15877,map__15877__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__15877,map__15877__$1,messages,warnings,exception))
;
...
}catch (e15880){if((e15880 instanceof Error)){
var __15881 = e15880;
} else {
throw e15880;
