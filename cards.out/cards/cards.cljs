...
(defcard
  ...
  (fn [props _]
    (dom/div #js {:className "parent" :style #js {:width "50px"}}
...
(defcard
  ...
  (fn [props _]
    (dom/div #js {:className "parent" :style #js {:width "100px"}}
      (kanban-card/card @props)))
...
(defcard
  ...
  (fn [props _]
    (dom/div #js {:className "parent" :style #js {:width "200px"}}
      (kanban-card/card @props)))
...
(defcard
  ...
  (fn [props _]
    (dom/div #js {:className "parent" :style #js {:width "300px"}}
      (kanban-card/card @props)))
