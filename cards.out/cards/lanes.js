...
return kanban.components.lane.lane.call(null,cljs.core.deref.call(null,props));
}),new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(1),new cljs.core.Keyword(null,"name","name",1843675177),"Backlog",new cljs.core.Keyword(null,"cards","cards",169174038),(function (){var iter__5866__auto__ = (function cards$lanes$iter__33622(s__33623){
return (new cljs.core.LazySeq(null,(function (){
var s__33623__$1 = s__33623;
while(true){
var temp__4425__auto__ = cljs.core.seq.call(null,s__33623__$1);
if(temp__4425__auto__){
var s__33623__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__33623__$2)){
var c__5864__auto__ = cljs.core.chunk_first.call(null,s__33623__$2);
var size__5865__auto__ = cljs.core.count.call(null,c__5864__auto__);
var b__33625 = cljs.core.chunk_buffer.call(null,size__5865__auto__);
if((function (){var i__33624 = (0);
while(true){
if((i__33624 < size__5865__auto__)){
var i = cljs.core._nth.call(null,c__5864__auto__,i__33624);
cljs.core.chunk_append.call(null,b__33625,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),i,new cljs.core.Keyword(null,"text","text",-1790561697),[cljs.core.str("Card number "),cljs.core.str(i),cljs.core.str(" in this lane. "),cljs.core.str("This one has a rather long caption.")].join(''),new cljs.core.Keyword(null,"assignees","assignees",-298534943),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(1),new cljs.core.Keyword(null,"username","username",1605666410),"ada",new cljs.core.Keyword(null,"name","name",1843675177),"Ada Lovelace"], null)], null)], null));

var G__33626 = (i__33624 + (1));
i__33624 = G__33626;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__33625),cards$lanes$iter__33622.call(null,cljs.core.chunk_rest.call(null,s__33623__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__33625),null);
}
} else {
var i = cljs.core.first.call(null,s__33623__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),i,new cljs.core.Keyword(null,"text","text",-1790561697),[cljs.core.str("Card number "),cljs.core.str(i),cljs.core.str(" in this lane. "),cljs.core.str("This one has a rather long caption.")].join(''),new cljs.core.Keyword(null,"assignees","assignees",-298534943),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(1),new cljs.core.Keyword(null,"username","username",1605666410),"ada",new cljs.core.Keyword(null,"name","name",1843675177),"Ada Lovelace"], null)], null)], null),cards$lanes$iter__33622.call(null,cljs.core.rest.call(null,s__33623__$2)));
}
} else {
return null;
}
...
}),new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(1),new cljs.core.Keyword(null,"name","name",1843675177),"Backlog",new cljs.core.Keyword(null,"cards","cards",169174038),(function (){var iter__5866__auto__ = (function cards$lanes$iter__33627(s__33628){
return (new cljs.core.LazySeq(null,(function (){
var s__33628__$1 = s__33628;
while(true){
var temp__4425__auto__ = cljs.core.seq.call(null,s__33628__$1);
if(temp__4425__auto__){
var s__33628__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__33628__$2)){
var c__5864__auto__ = cljs.core.chunk_first.call(null,s__33628__$2);
var size__5865__auto__ = cljs.core.count.call(null,c__5864__auto__);
var b__33630 = cljs.core.chunk_buffer.call(null,size__5865__auto__);
if((function (){var i__33629 = (0);
while(true){
if((i__33629 < size__5865__auto__)){
var i = cljs.core._nth.call(null,c__5864__auto__,i__33629);
cljs.core.chunk_append.call(null,b__33630,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),i,new cljs.core.Keyword(null,"text","text",-1790561697),[cljs.core.str("Card number "),cljs.core.str(i),cljs.core.str(" in this lane. "),cljs.core.str("This one has a rather long caption.")].join(''),new cljs.core.Keyword(null,"assignees","assignees",-298534943),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(1),new cljs.core.Keyword(null,"username","username",1605666410),"ada",new cljs.core.Keyword(null,"name","name",1843675177),"Ada Lovelace"], null)], null)], null));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__33630),cards$lanes$iter__33627.call(null,cljs.core.chunk_rest.call(null,s__33628__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__33630),null);
}
} else {
var i = cljs.core.first.call(null,s__33628__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),i,new cljs.core.Keyword(null,"text","text",-1790561697),[cljs.core.str("Card number "),cljs.core.str(i),cljs.core.str(" in this lane. "),cljs.core.str("This one has a rather long caption.")].join(''),new cljs.core.Keyword(null,"assignees","assignees",-298534943),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(1),new cljs.core.Keyword(null,"username","username",1605666410),"ada",new cljs.core.Keyword(null,"name","name",1843675177),"Ada Lovelace"], null)], null)], null),cards$lanes$iter__33627.call(null,cljs.core.rest.call(null,s__33628__$2)));
}
} else {
return null;
}
