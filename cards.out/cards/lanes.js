...
return kanban.components.lane.lane.call(null,cljs.core.deref.call(null,props));
}),new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(1),new cljs.core.Keyword(null,"name","name",1843675177),"Backlog",new cljs.core.Keyword(null,"cards","cards",169174038),(function (){var iter__5866__auto__ = (function cards$lanes$iter__82727(s__82728){
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__82730),cards$lanes$iter__82727.call(null,cljs.core.chunk_rest.call(null,s__82728__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__82730),null);
}
} else {
var i = cljs.core.first.call(null,s__82728__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),i,new cljs.core.Keyword(null,"text","text",-1790561697),[cljs.core.str("Card number "),cljs.core.str(i),cljs.core.str(" in this lane. "),cljs.core.str("This one has a rather long caption.")].join(''),new cljs.core.Keyword(null,"assignees","assignees",-298534943),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(1),new cljs.core.Keyword(null,"username","username",1605666410),"ada",new cljs.core.Keyword(null,"name","name",1843675177),"Ada Lovelace"], null)], null)], null),cards$lanes$iter__82727.call(null,cljs.core.rest.call(null,s__82728__$2)));
}
} else {
return null;
}
...
}),new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(1),new cljs.core.Keyword(null,"name","name",1843675177),"Backlog",new cljs.core.Keyword(null,"cards","cards",169174038),(function (){var iter__5866__auto__ = (function cards$lanes$iter__82732(s__82733){
return (new cljs.core.LazySeq(null,(function (){
var s__82733__$1 = s__82733;
while(true){
var temp__4425__auto__ = cljs.core.seq.call(null,s__82733__$1);
if(temp__4425__auto__){
var s__82733__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__82733__$2)){
var c__5864__auto__ = cljs.core.chunk_first.call(null,s__82733__$2);
var size__5865__auto__ = cljs.core.count.call(null,c__5864__auto__);
var b__82735 = cljs.core.chunk_buffer.call(null,size__5865__auto__);
if((function (){var i__82734 = (0);
while(true){
if((i__82734 < size__5865__auto__)){
var i = cljs.core._nth.call(null,c__5864__auto__,i__82734);
cljs.core.chunk_append.call(null,b__82735,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),i,new cljs.core.Keyword(null,"text","text",-1790561697),[cljs.core.str("Card number "),cljs.core.str(i),cljs.core.str(" in this lane. "),cljs.core.str("This one has a rather long caption.")].join(''),new cljs.core.Keyword(null,"assignees","assignees",-298534943),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(1),new cljs.core.Keyword(null,"username","username",1605666410),"ada",new cljs.core.Keyword(null,"name","name",1843675177),"Ada Lovelace"], null)], null)], null));

var G__82736 = (i__82734 + (1));
i__82734 = G__82736;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__82735),cards$lanes$iter__82732.call(null,cljs.core.chunk_rest.call(null,s__82733__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__82735),null);
}
} else {
var i = cljs.core.first.call(null,s__82733__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),i,new cljs.core.Keyword(null,"text","text",-1790561697),[cljs.core.str("Card number "),cljs.core.str(i),cljs.core.str(" in this lane. "),cljs.core.str("This one has a rather long caption.")].join(''),new cljs.core.Keyword(null,"assignees","assignees",-298534943),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(1),new cljs.core.Keyword(null,"username","username",1605666410),"ada",new cljs.core.Keyword(null,"name","name",1843675177),"Ada Lovelace"], null)], null)], null),cards$lanes$iter__82732.call(null,cljs.core.rest.call(null,s__82733__$2)));
}
} else {
return null;
}
...
return React.DOM.div(null,React.DOM.div({"style": {"display": "table", "width": "100%", "tableLayout": "fixed", "borderSpacing": "0.5rem"}},(function (){var iter__5866__auto__ = (function cards$lanes$iter__82737(s__82738){
return (new cljs.core.LazySeq(null,(function (){
var s__82738__$1 = s__82738;
while(true){
var temp__4425__auto__ = cljs.core.seq.call(null,s__82738__$1);
if(temp__4425__auto__){
var s__82738__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__82738__$2)){
var c__5864__auto__ = cljs.core.chunk_first.call(null,s__82738__$2);
var size__5865__auto__ = cljs.core.count.call(null,c__5864__auto__);
var b__82740 = cljs.core.chunk_buffer.call(null,size__5865__auto__);
if((function (){var i__82739 = (0);
while(true){
if((i__82739 < size__5865__auto__)){
var lane = cljs.core._nth.call(null,c__5864__auto__,i__82739);
cljs.core.chunk_append.call(null,b__82740,kanban.components.lane.lane.call(null,om.next.computed.call(null,lane,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"card-drag-fns","card-drag-fns",-295465238),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"start","start",-355208981),cljs.core.partial.call(null,cards.util.update_cb_info,new cljs.core.Keyword(null,"start","start",-355208981),state),new cljs.core.Keyword(null,"end","end",-268185958),cljs.core.partial.call(null,cards.util.update_cb_info,new cljs.core.Keyword(null,"end","end",-268185958),state),new cljs.core.Keyword(null,"drop","drop",364481611),cljs.core.partial.call(null,cards.util.update_cb_info,new cljs.core.Keyword(null,"drop","drop",364481611),state)], null)], null))));

var G__82741 = (i__82739 + (1));
i__82739 = G__82741;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__82740),cards$lanes$iter__82737.call(null,cljs.core.chunk_rest.call(null,s__82738__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__82740),null);
}
} else {
var lane = cljs.core.first.call(null,s__82738__$2);
return cljs.core.cons.call(null,kanban.components.lane.lane.call(null,om.next.computed.call(null,lane,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"card-drag-fns","card-drag-fns",-295465238),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"start","start",-355208981),cljs.core.partial.call(null,cards.util.update_cb_info,new cljs.core.Keyword(null,"start","start",-355208981),state),new cljs.core.Keyword(null,"end","end",-268185958),cljs.core.partial.call(null,cards.util.update_cb_info,new cljs.core.Keyword(null,"end","end",-268185958),state),new cljs.core.Keyword(null,"drop","drop",364481611),cljs.core.partial.call(null,cards.util.update_cb_info,new cljs.core.Keyword(null,"drop","drop",364481611),state)], null)], null))),cards$lanes$iter__82737.call(null,cljs.core.rest.call(null,s__82738__$2)));
}
} else {
return null;
}
...
return cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__82742_SHARP_){
return cljs.core._EQ_.call(null,id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__82742_SHARP_));
}),coll));
});
...
var vec__82747 = new cljs.core.Keyword(null,"drag-info","drag-info",2088919582).cljs$core$IFn$_invoke$arity$1(state__$1);
var from_ref = cljs.core.nth.call(null,vec__82747,(0),null);
var card_ref = cljs.core.nth.call(null,vec__82747,(1),null);
...
var new_from = cljs.core.update.call(null,from,new cljs.core.Keyword(null,"cards","cards",169174038),((function (from,to,card,vec__82747,from_ref,card_ref){
return (function (p1__82744_SHARP_,p2__82743_SHARP_){
return cljs.core.remove.call(null,cljs.core.PersistentHashSet.fromArray([p2__82743_SHARP_], true),p1__82744_SHARP_);
});})(from,to,card,vec__82747,from_ref,card_ref))
,card);
var new_to = cljs.core.update.call(null,to,new cljs.core.Keyword(null,"cards","cards",169174038),cljs.core.conj,card);
return cljs.core.update.call(null,cljs.core.dissoc.call(null,state__$1,new cljs.core.Keyword(null,"drag-info","drag-info",2088919582)),new cljs.core.Keyword(null,"lanes","lanes",1843627072),((function (from,to,card,new_from,new_to,vec__82747,from_ref,card_ref){
return (function (p1__82745_SHARP_){
return cljs.core.replace.call(null,cljs.core.PersistentArrayMap.fromArray([from,new_from,to,new_to], true, false),p1__82745_SHARP_);
});})(from,to,card,new_from,new_to,vec__82747,from_ref,card_ref))
);
}
}));
});
...
return React.DOM.div(null,React.DOM.div({"style": {"display": "table", "width": "100%", "tableLayout": "fixed", "borderSpacing": "0.5rem"}},(function (){var iter__5866__auto__ = (function cards$lanes$iter__82751(s__82752){
return (new cljs.core.LazySeq(null,(function (){
var s__82752__$1 = s__82752;
while(true){
var temp__4425__auto__ = cljs.core.seq.call(null,s__82752__$1);
if(temp__4425__auto__){
var s__82752__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__82752__$2)){
var c__5864__auto__ = cljs.core.chunk_first.call(null,s__82752__$2);
var size__5865__auto__ = cljs.core.count.call(null,c__5864__auto__);
var b__82754 = cljs.core.chunk_buffer.call(null,size__5865__auto__);
if((function (){var i__82753 = (0);
while(true){
if((i__82753 < size__5865__auto__)){
var lane = cljs.core._nth.call(null,c__5864__auto__,i__82753);
cljs.core.chunk_append.call(null,b__82754,kanban.components.lane.lane.call(null,om.next.computed.call(null,lane,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"card-drag-fns","card-drag-fns",-295465238),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"start","start",-355208981),((function (i__82753,lane,c__5864__auto__,size__5865__auto__,b__82754,s__82752__$2,temp__4425__auto__){
return (function (p1__82748_SHARP_,p2__82749_SHARP_){
return cljs.core.swap_BANG_.call(null,state,cljs.core.assoc,new cljs.core.Keyword(null,"drag-info","drag-info",2088919582),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__82748_SHARP_,p2__82749_SHARP_], null));
});})(i__82753,lane,c__5864__auto__,size__5865__auto__,b__82754,s__82752__$2,temp__4425__auto__))
,new cljs.core.Keyword(null,"end","end",-268185958),((function (i__82753,lane,c__5864__auto__,size__5865__auto__,b__82754,s__82752__$2,temp__4425__auto__){
return (function (){
return cljs.core.swap_BANG_.call(null,state,cljs.core.dissoc,new cljs.core.Keyword(null,"drag-info","drag-info",2088919582));
});})(i__82753,lane,c__5864__auto__,size__5865__auto__,b__82754,s__82752__$2,temp__4425__auto__))
,new cljs.core.Keyword(null,"drop","drop",364481611),((function (i__82753,lane,c__5864__auto__,size__5865__auto__,b__82754,s__82752__$2,temp__4425__auto__){
return (function (p1__82750_SHARP_){
return cards.lanes.move_card.call(null,state,p1__82750_SHARP_);
});})(i__82753,lane,c__5864__auto__,size__5865__auto__,b__82754,s__82752__$2,temp__4425__auto__))
], null)], null))));

var G__82755 = (i__82753 + (1));
i__82753 = G__82755;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__82754),cards$lanes$iter__82751.call(null,cljs.core.chunk_rest.call(null,s__82752__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__82754),null);
}
} else {
var lane = cljs.core.first.call(null,s__82752__$2);
return cljs.core.cons.call(null,kanban.components.lane.lane.call(null,om.next.computed.call(null,lane,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"card-drag-fns","card-drag-fns",-295465238),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"start","start",-355208981),((function (lane,s__82752__$2,temp__4425__auto__){
return (function (p1__82748_SHARP_,p2__82749_SHARP_){
return cljs.core.swap_BANG_.call(null,state,cljs.core.assoc,new cljs.core.Keyword(null,"drag-info","drag-info",2088919582),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__82748_SHARP_,p2__82749_SHARP_], null));
});})(lane,s__82752__$2,temp__4425__auto__))
,new cljs.core.Keyword(null,"end","end",-268185958),((function (lane,s__82752__$2,temp__4425__auto__){
return (function (){
return cljs.core.swap_BANG_.call(null,state,cljs.core.dissoc,new cljs.core.Keyword(null,"drag-info","drag-info",2088919582));
});})(lane,s__82752__$2,temp__4425__auto__))
,new cljs.core.Keyword(null,"drop","drop",364481611),((function (lane,s__82752__$2,temp__4425__auto__){
return (function (p1__82750_SHARP_){
return cards.lanes.move_card.call(null,state,p1__82750_SHARP_);
});})(lane,s__82752__$2,temp__4425__auto__))
], null)], null))),cards$lanes$iter__82751.call(null,cljs.core.rest.call(null,s__82752__$2)));
}
} else {
return null;
}
