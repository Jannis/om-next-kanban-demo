...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__17024),cards$lanes$iter__17021.call(null,cljs.core.chunk_rest.call(null,s__17022__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__17024),null);
}
} else {
var i = cljs.core.first.call(null,s__17022__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),i,new cljs.core.Keyword(null,"text","text",-1790561697),[cljs.core.str("Card number "),cljs.core.str(i),cljs.core.str(" in this lane. "),cljs.core.str("This one has a rather long caption.")].join(''),new cljs.core.Keyword(null,"assignees","assignees",-298534943),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(1),new cljs.core.Keyword(null,"username","username",1605666410),"ada",new cljs.core.Keyword(null,"name","name",1843675177),"Ada Lovelace"], null)], null)], null),cards$lanes$iter__17021.call(null,cljs.core.rest.call(null,s__17022__$2)));
}
} else {
return null;
}
...
return iter__5940__auto__.call(null,cljs.core.range.call(null,(0),(50)));
...
}),new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(1),new cljs.core.Keyword(null,"name","name",1843675177),"Backlog",new cljs.core.Keyword(null,"cards","cards",169174038),(function (){var iter__5940__auto__ = (function cards$lanes$iter__17026(s__17027){
return (new cljs.core.LazySeq(null,(function (){
var s__17027__$1 = s__17027;
while(true){
var temp__4425__auto__ = cljs.core.seq.call(null,s__17027__$1);
if(temp__4425__auto__){
var s__17027__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__17027__$2)){
var c__5938__auto__ = cljs.core.chunk_first.call(null,s__17027__$2);
var size__5939__auto__ = cljs.core.count.call(null,c__5938__auto__);
var b__17029 = cljs.core.chunk_buffer.call(null,size__5939__auto__);
if((function (){var i__17028 = (0);
while(true){
if((i__17028 < size__5939__auto__)){
var i = cljs.core._nth.call(null,c__5938__auto__,i__17028);
cljs.core.chunk_append.call(null,b__17029,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),i,new cljs.core.Keyword(null,"text","text",-1790561697),[cljs.core.str("Card number "),cljs.core.str(i),cljs.core.str(" in this lane. "),cljs.core.str("This one has a rather long caption.")].join(''),new cljs.core.Keyword(null,"assignees","assignees",-298534943),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(1),new cljs.core.Keyword(null,"username","username",1605666410),"ada",new cljs.core.Keyword(null,"name","name",1843675177),"Ada Lovelace"], null)], null)], null));

var G__17030 = (i__17028 + (1));
i__17028 = G__17030;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__17029),cards$lanes$iter__17026.call(null,cljs.core.chunk_rest.call(null,s__17027__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__17029),null);
}
} else {
var i = cljs.core.first.call(null,s__17027__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),i,new cljs.core.Keyword(null,"text","text",-1790561697),[cljs.core.str("Card number "),cljs.core.str(i),cljs.core.str(" in this lane. "),cljs.core.str("This one has a rather long caption.")].join(''),new cljs.core.Keyword(null,"assignees","assignees",-298534943),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(1),new cljs.core.Keyword(null,"username","username",1605666410),"ada",new cljs.core.Keyword(null,"name","name",1843675177),"Ada Lovelace"], null)], null)], null),cards$lanes$iter__17026.call(null,cljs.core.rest.call(null,s__17027__$2)));
}
} else {
return null;
}
...
return React.DOM.div(null,React.DOM.div({"style": {"display": "table", "width": "100%", "tableLayout": "fixed", "borderSpacing": "0.5rem"}},(function (){var iter__5940__auto__ = (function cards$lanes$iter__17031(s__17032){
return (new cljs.core.LazySeq(null,(function (){
var s__17032__$1 = s__17032;
while(true){
var temp__4425__auto__ = cljs.core.seq.call(null,s__17032__$1);
if(temp__4425__auto__){
var s__17032__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__17032__$2)){
var c__5938__auto__ = cljs.core.chunk_first.call(null,s__17032__$2);
var size__5939__auto__ = cljs.core.count.call(null,c__5938__auto__);
var b__17034 = cljs.core.chunk_buffer.call(null,size__5939__auto__);
if((function (){var i__17033 = (0);
while(true){
if((i__17033 < size__5939__auto__)){
var lane = cljs.core._nth.call(null,c__5938__auto__,i__17033);
cljs.core.chunk_append.call(null,b__17034,kanban.components.lane.lane.call(null,om.next.computed.call(null,lane,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"card-drag-fns","card-drag-fns",-295465238),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"start","start",-355208981),cljs.core.partial.call(null,cards.util.update_cb_info,new cljs.core.Keyword(null,"start","start",-355208981),state),new cljs.core.Keyword(null,"end","end",-268185958),cljs.core.partial.call(null,cards.util.update_cb_info,new cljs.core.Keyword(null,"end","end",-268185958),state),new cljs.core.Keyword(null,"drop","drop",364481611),cljs.core.partial.call(null,cards.util.update_cb_info,new cljs.core.Keyword(null,"drop","drop",364481611),state)], null)], null))));

var G__17035 = (i__17033 + (1));
i__17033 = G__17035;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__17034),cards$lanes$iter__17031.call(null,cljs.core.chunk_rest.call(null,s__17032__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__17034),null);
}
} else {
var lane = cljs.core.first.call(null,s__17032__$2);
return cljs.core.cons.call(null,kanban.components.lane.lane.call(null,om.next.computed.call(null,lane,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"card-drag-fns","card-drag-fns",-295465238),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"start","start",-355208981),cljs.core.partial.call(null,cards.util.update_cb_info,new cljs.core.Keyword(null,"start","start",-355208981),state),new cljs.core.Keyword(null,"end","end",-268185958),cljs.core.partial.call(null,cards.util.update_cb_info,new cljs.core.Keyword(null,"end","end",-268185958),state),new cljs.core.Keyword(null,"drop","drop",364481611),cljs.core.partial.call(null,cards.util.update_cb_info,new cljs.core.Keyword(null,"drop","drop",364481611),state)], null)], null))),cards$lanes$iter__17031.call(null,cljs.core.rest.call(null,s__17032__$2)));
}
} else {
return null;
}
...
return iter__5940__auto__.call(null,new cljs.core.Keyword(null,"lanes","lanes",1843627072).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,state)));
...
return cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__17036_SHARP_){
return cljs.core._EQ_.call(null,id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__17036_SHARP_));
}),coll));
});
...
var vec__17041 = new cljs.core.Keyword(null,"drag-info","drag-info",2088919582).cljs$core$IFn$_invoke$arity$1(state__$1);
var from_ref = cljs.core.nth.call(null,vec__17041,(0),null);
var card_ref = cljs.core.nth.call(null,vec__17041,(1),null);
...
var new_from = cljs.core.update.call(null,from,new cljs.core.Keyword(null,"cards","cards",169174038),((function (from,to,card,vec__17041,from_ref,card_ref){
return (function (p1__17038_SHARP_,p2__17037_SHARP_){
return cljs.core.remove.call(null,cljs.core.PersistentHashSet.fromArray([p2__17037_SHARP_], true),p1__17038_SHARP_);
});})(from,to,card,vec__17041,from_ref,card_ref))
,card);
var new_to = cljs.core.update.call(null,to,new cljs.core.Keyword(null,"cards","cards",169174038),cljs.core.conj,card);
return cljs.core.update.call(null,cljs.core.dissoc.call(null,state__$1,new cljs.core.Keyword(null,"drag-info","drag-info",2088919582)),new cljs.core.Keyword(null,"lanes","lanes",1843627072),((function (from,to,card,new_from,new_to,vec__17041,from_ref,card_ref){
return (function (p1__17039_SHARP_){
return cljs.core.replace.call(null,cljs.core.PersistentArrayMap.fromArray([from,new_from,to,new_to], true, false),p1__17039_SHARP_);
});})(from,to,card,new_from,new_to,vec__17041,from_ref,card_ref))
);
}
}));
});
...
return React.DOM.div(null,React.DOM.div({"style": {"display": "table", "width": "100%", "tableLayout": "fixed", "borderSpacing": "0.5rem"}},(function (){var iter__5940__auto__ = (function cards$lanes$iter__17045(s__17046){
return (new cljs.core.LazySeq(null,(function (){
var s__17046__$1 = s__17046;
while(true){
var temp__4425__auto__ = cljs.core.seq.call(null,s__17046__$1);
if(temp__4425__auto__){
var s__17046__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__17046__$2)){
var c__5938__auto__ = cljs.core.chunk_first.call(null,s__17046__$2);
var size__5939__auto__ = cljs.core.count.call(null,c__5938__auto__);
var b__17048 = cljs.core.chunk_buffer.call(null,size__5939__auto__);
if((function (){var i__17047 = (0);
while(true){
if((i__17047 < size__5939__auto__)){
var lane = cljs.core._nth.call(null,c__5938__auto__,i__17047);
cljs.core.chunk_append.call(null,b__17048,kanban.components.lane.lane.call(null,om.next.computed.call(null,lane,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"card-drag-fns","card-drag-fns",-295465238),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"start","start",-355208981),((function (i__17047,lane,c__5938__auto__,size__5939__auto__,b__17048,s__17046__$2,temp__4425__auto__){
return (function (p1__17042_SHARP_,p2__17043_SHARP_){
return cljs.core.swap_BANG_.call(null,state,cljs.core.assoc,new cljs.core.Keyword(null,"drag-info","drag-info",2088919582),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__17042_SHARP_,p2__17043_SHARP_], null));
});})(i__17047,lane,c__5938__auto__,size__5939__auto__,b__17048,s__17046__$2,temp__4425__auto__))
,new cljs.core.Keyword(null,"end","end",-268185958),((function (i__17047,lane,c__5938__auto__,size__5939__auto__,b__17048,s__17046__$2,temp__4425__auto__){
return (function (){
return cljs.core.swap_BANG_.call(null,state,cljs.core.dissoc,new cljs.core.Keyword(null,"drag-info","drag-info",2088919582));
});})(i__17047,lane,c__5938__auto__,size__5939__auto__,b__17048,s__17046__$2,temp__4425__auto__))
,new cljs.core.Keyword(null,"drop","drop",364481611),((function (i__17047,lane,c__5938__auto__,size__5939__auto__,b__17048,s__17046__$2,temp__4425__auto__){
return (function (p1__17044_SHARP_){
return cards.lanes.move_card.call(null,state,p1__17044_SHARP_);
});})(i__17047,lane,c__5938__auto__,size__5939__auto__,b__17048,s__17046__$2,temp__4425__auto__))
], null)], null))));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__17048),cards$lanes$iter__17045.call(null,cljs.core.chunk_rest.call(null,s__17046__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__17048),null);
}
} else {
var lane = cljs.core.first.call(null,s__17046__$2);
return cljs.core.cons.call(null,kanban.components.lane.lane.call(null,om.next.computed.call(null,lane,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"card-drag-fns","card-drag-fns",-295465238),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"start","start",-355208981),((function (lane,s__17046__$2,temp__4425__auto__){
return (function (p1__17042_SHARP_,p2__17043_SHARP_){
return cljs.core.swap_BANG_.call(null,state,cljs.core.assoc,new cljs.core.Keyword(null,"drag-info","drag-info",2088919582),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__17042_SHARP_,p2__17043_SHARP_], null));
});})(lane,s__17046__$2,temp__4425__auto__))
,new cljs.core.Keyword(null,"end","end",-268185958),((function (lane,s__17046__$2,temp__4425__auto__){
return (function (){
return cljs.core.swap_BANG_.call(null,state,cljs.core.dissoc,new cljs.core.Keyword(null,"drag-info","drag-info",2088919582));
});})(lane,s__17046__$2,temp__4425__auto__))
,new cljs.core.Keyword(null,"drop","drop",364481611),((function (lane,s__17046__$2,temp__4425__auto__){
return (function (p1__17044_SHARP_){
return cards.lanes.move_card.call(null,state,p1__17044_SHARP_);
});})(lane,s__17046__$2,temp__4425__auto__))
], null)], null))),cards$lanes$iter__17045.call(null,cljs.core.rest.call(null,s__17046__$2)));
}
} else {
return null;
}
