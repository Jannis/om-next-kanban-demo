...
args20283.push((arguments[i__6153__auto___20288]));
...
var G__20286__$1 = ((cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter))?cljs.core.assoc.call(null,G__20286,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint):G__20286);
return G__20286__$1;
});
...
var len__6152__auto___20294 = arguments.length;
var i__6153__auto___20295 = (0);
while(true){
if((i__6153__auto___20295 < len__6152__auto___20294)){
args__6159__auto__.push((arguments[i__6153__auto___20295]));

var G__20296 = (i__6153__auto___20295 + (1));
i__6153__auto___20295 = G__20296;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq20291){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__20292,G__20293,seq20291__$2);
});
...
var line = cljs.core.get.call(null,map__20300__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__20300__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__20300,map__20300__$1,file,line,column){
return (function (p1__20297_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__20297_SHARP_));
});})(map__20300,map__20300__$1,file,line,column))
...
var temp__4425__auto___20302 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___20302)){
var message_20303 = temp__4425__auto___20302;
cljs.core.println.call(null,message_20303);
} else {
}
...
var temp__4425__auto___20304 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___20304)){
var message_20305 = temp__4425__auto___20304;
cljs.core.println.call(null,message_20305);
} else {
}
...
var G__20311 = exception.stack;
var G__20311__$1 = (((G__20311 == null))?null:clojure.string.split_lines.call(null,G__20311));
var G__20311__$2 = (((G__20311__$1 == null))?null:cljs.core.get.call(null,G__20311__$1,depth));
var G__20311__$3 = (((G__20311__$2 == null))?null:clojure.string.trim.call(null,G__20311__$2));
return G__20311__$3;
} else {
...
var vec__20312 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__20312,(0),null);
var column = cljs.core.nth.call(null,vec__20312,(1),null);
var vec__20313 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__20313,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__20313,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__20313,(2),null);
...
var m__$1 = (function (){var G__20315 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__20315) {
case "fail":
...
var G__20321 = (function (){var G__20320 = cljs.core.rest.call(null,fns);
var G__20320__$1 = (cljs.core.truth_(new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,obj)))?cljs.core.concat.call(null,obj,G__20320):G__20320);
return G__20320__$1;
})();
fns = G__20321;
continue;
...
var G__20323 = fns;
var G__20323__$1 = (((G__20323 == null))?null:cljs.core.vary_meta.call(null,G__20323,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true));
return G__20323__$1;
});
...
var G__20327 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__20327) {
...
var vec__20330 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__20330,(0),null);
var types = vec__20330;
...
return cljs.core.map.call(null,(function (p__20338){
var vec__20339 = p__20338;
var ns = cljs.core.nth.call(null,vec__20339,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__20339,(1),null);
return ((function (vec__20339,ns,vars__$1){
return (function (){
...
var G__20340 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__20340) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__20340,env,once_fixtures,each_fixtures,vec__20339,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__20340,env,once_fixtures,each_fixtures,vec__20339,ns,vars__$1){
return (function (){
var seq__20341 = cljs.core.seq.call(null,vars__$1);
var chunk__20342 = null;
var count__20343 = (0);
var i__20344 = (0);
while(true){
if((i__20344 < count__20343)){
var v = cljs.core._nth.call(null,chunk__20342,i__20344);
var temp__4425__auto___20346 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___20346)){
var t_20347 = temp__4425__auto___20346;
each_fixture_fn.call(null,((function (seq__20341,chunk__20342,count__20343,i__20344,t_20347,temp__4425__auto___20346,v,each_fixture_fn,G__20340,env,once_fixtures,each_fixtures,vec__20339,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20347)));
});})(seq__20341,chunk__20342,count__20343,i__20344,t_20347,temp__4425__auto___20346,v,each_fixture_fn,G__20340,env,once_fixtures,each_fixtures,vec__20339,ns,vars__$1))
);
} else {
}

var G__20348 = seq__20341;
var G__20349 = chunk__20342;
var G__20350 = count__20343;
var G__20351 = (i__20344 + (1));
seq__20341 = G__20348;
chunk__20342 = G__20349;
count__20343 = G__20350;
i__20344 = G__20351;
continue;
} else {
var temp__4425__auto__ = cljs.core.seq.call(null,seq__20341);
if(temp__4425__auto__){
var seq__20341__$1 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__20341__$1)){
var c__5897__auto__ = cljs.core.chunk_first.call(null,seq__20341__$1);
var G__20352 = cljs.core.chunk_rest.call(null,seq__20341__$1);
var G__20353 = c__5897__auto__;
var G__20354 = cljs.core.count.call(null,c__5897__auto__);
var G__20355 = (0);
seq__20341 = G__20352;
chunk__20342 = G__20353;
count__20343 = G__20354;
i__20344 = G__20355;
continue;
} else {
var v = cljs.core.first.call(null,seq__20341__$1);
var temp__4425__auto___20356__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___20356__$1)){
var t_20357 = temp__4425__auto___20356__$1;
each_fixture_fn.call(null,((function (seq__20341,chunk__20342,count__20343,i__20344,t_20357,temp__4425__auto___20356__$1,v,seq__20341__$1,temp__4425__auto__,each_fixture_fn,G__20340,env,once_fixtures,each_fixtures,vec__20339,ns,vars__$1){
return (function (){
...
});})(seq__20341,chunk__20342,count__20343,i__20344,t_20357,temp__4425__auto___20356__$1,v,seq__20341__$1,temp__4425__auto__,each_fixture_fn,G__20340,env,once_fixtures,each_fixtures,vec__20339,ns,vars__$1))
);
} else {
}

var G__20358 = cljs.core.next.call(null,seq__20341__$1);
var G__20359 = null;
var G__20360 = (0);
var G__20361 = (0);
seq__20341 = G__20358;
chunk__20342 = G__20359;
count__20343 = G__20360;
i__20344 = G__20361;
continue;
}
} else {
...
});})(each_fixture_fn,G__20340,env,once_fixtures,each_fixtures,vec__20339,ns,vars__$1))
);
});})(each_fixture_fn,G__20340,env,once_fixtures,each_fixtures,vec__20339,ns,vars__$1))
], null);
