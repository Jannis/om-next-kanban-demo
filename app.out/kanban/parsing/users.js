...
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__8271_SHARP_){
return kanban.parsing.users.get_user.call(null,st,p1__8271_SHARP_);
})),cljs.core.get.call(null,st,key));
});
kanban.parsing.users.resolve_users = (function kanban$parsing$users$resolve_users(st,refs){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__8272_SHARP_){
return kanban.parsing.users.get_user.call(null,st,p1__8272_SHARP_);
}),refs));
});
cljs.core._add_method.call(null,kanban.reconciler.read,new cljs.core.Keyword(null,"users","users",-713552705),(function (p__8273,key,_){
...
var state = cljs.core.get.call(null,map__8274__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
