...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__8549,opts){
...
var files = cljs.core.get.call(null,map__8550__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6152__auto___8556 = arguments.length;
var i__6153__auto___8557 = (0);
while(true){
if((i__6153__auto___8557 < len__6152__auto___8556)){
args__6159__auto__.push((arguments[i__6153__auto___8557]));

var G__8558 = (i__6153__auto___8557 + (1));
i__6153__auto___8557 = G__8558;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__8554){
var vec__8555 = p__8554;
var opts = cljs.core.nth.call(null,vec__8555,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__8555,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__8555,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__8555,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__8555,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq8552){
var G__8553 = cljs.core.first.call(null,seq8552);
var seq8552__$1 = cljs.core.next.call(null,seq8552);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__8553,seq8552__$1);
});
