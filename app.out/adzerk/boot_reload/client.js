...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__15589,opts){
var map__15590 = p__15589;
var map__15590__$1 = ((((!((map__15590 == null)))?((((map__15590.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15590.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15590):map__15590);
var files = cljs.core.get.call(null,map__15590__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6152__auto___15596 = arguments.length;
var i__6153__auto___15597 = (0);
while(true){
if((i__6153__auto___15597 < len__6152__auto___15596)){
args__6159__auto__.push((arguments[i__6153__auto___15597]));

var G__15598 = (i__6153__auto___15597 + (1));
i__6153__auto___15597 = G__15598;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__15594){
var vec__15595 = p__15594;
var opts = cljs.core.nth.call(null,vec__15595,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__15595,opts){
return (function (evt){
...
});})(conn,vec__15595,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__15595,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__15595,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__15595,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq15592){
var G__15593 = cljs.core.first.call(null,seq15592);
var seq15592__$1 = cljs.core.next.call(null,seq15592);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__15593,seq15592__$1);
});
