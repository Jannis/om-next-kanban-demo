...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__8389,opts){
var map__8390 = p__8389;
var map__8390__$1 = ((((!((map__8390 == null)))?((((map__8390.cljs$lang$protocol_mask$partition0$ & (64))) || (map__8390.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8390):map__8390);
var files = cljs.core.get.call(null,map__8390__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6152__auto___8396 = arguments.length;
var i__6153__auto___8397 = (0);
while(true){
if((i__6153__auto___8397 < len__6152__auto___8396)){
args__6159__auto__.push((arguments[i__6153__auto___8397]));

var G__8398 = (i__6153__auto___8397 + (1));
i__6153__auto___8397 = G__8398;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__8394){
var vec__8395 = p__8394;
var opts = cljs.core.nth.call(null,vec__8395,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__8395,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__8395,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__8395,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__8395,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq8392){
var G__8393 = cljs.core.first.call(null,seq8392);
var seq8392__$1 = cljs.core.next.call(null,seq8392);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__8393,seq8392__$1);
});
