...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__15527,opts){
...
var files = cljs.core.get.call(null,map__15528__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
args__6159__auto__.push((arguments[i__6153__auto___15535]));
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__15532){
var vec__15533 = p__15532;
var opts = cljs.core.nth.call(null,vec__15533,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__15533,opts){
return (function (evt){
...
});})(conn,vec__15533,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__15533,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__15533,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__15533,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq15530){
var G__15531 = cljs.core.first.call(null,seq15530);
var seq15530__$1 = cljs.core.next.call(null,seq15530);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__15531,seq15530__$1);
});
