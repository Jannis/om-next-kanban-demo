...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__8393,opts){
var map__8394 = p__8393;
var map__8394__$1 = ((((!((map__8394 == null)))?((((map__8394.cljs$lang$protocol_mask$partition0$ & (64))) || (map__8394.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8394):map__8394);
var files = cljs.core.get.call(null,map__8394__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__8398){
var vec__8399 = p__8398;
var opts = cljs.core.nth.call(null,vec__8399,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__8399,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__8399,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__8399,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__8399,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq8396){
var G__8397 = cljs.core.first.call(null,seq8396);
var seq8396__$1 = cljs.core.next.call(null,seq8396);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__8397,seq8396__$1);
});
