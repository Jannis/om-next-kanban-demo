...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__8351,opts){
var map__8352 = p__8351;
var map__8352__$1 = ((((!((map__8352 == null)))?((((map__8352.cljs$lang$protocol_mask$partition0$ & (64))) || (map__8352.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8352):map__8352);
var files = cljs.core.get.call(null,map__8352__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6152__auto___8358 = arguments.length;
var i__6153__auto___8359 = (0);
while(true){
if((i__6153__auto___8359 < len__6152__auto___8358)){
args__6159__auto__.push((arguments[i__6153__auto___8359]));

var G__8360 = (i__6153__auto___8359 + (1));
i__6153__auto___8359 = G__8360;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__8356){
var vec__8357 = p__8356;
var opts = cljs.core.nth.call(null,vec__8357,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__8357,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__8357,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__8357,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__8357,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq8354){
var G__8355 = cljs.core.first.call(null,seq8354);
var seq8354__$1 = cljs.core.next.call(null,seq8354);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__8355,seq8354__$1);
});
