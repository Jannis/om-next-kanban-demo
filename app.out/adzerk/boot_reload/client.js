...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__15515,opts){
var map__15516 = p__15515;
var map__15516__$1 = ((((!((map__15516 == null)))?((((map__15516.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15516.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15516):map__15516);
var files = cljs.core.get.call(null,map__15516__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6152__auto___15522 = arguments.length;
var i__6153__auto___15523 = (0);
while(true){
if((i__6153__auto___15523 < len__6152__auto___15522)){
args__6159__auto__.push((arguments[i__6153__auto___15523]));

var G__15524 = (i__6153__auto___15523 + (1));
i__6153__auto___15523 = G__15524;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__15520){
var vec__15521 = p__15520;
var opts = cljs.core.nth.call(null,vec__15521,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__15521,opts){
return (function (evt){
...
});})(conn,vec__15521,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__15521,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__15521,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__15521,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq15518){
var G__15519 = cljs.core.first.call(null,seq15518);
var seq15518__$1 = cljs.core.next.call(null,seq15518);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__15519,seq15518__$1);
});
