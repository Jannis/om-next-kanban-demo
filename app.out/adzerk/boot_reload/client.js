...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__8677,opts){
var map__8678 = p__8677;
...
var files = cljs.core.get.call(null,map__8678__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6152__auto___8684 = arguments.length;
var i__6153__auto___8685 = (0);
while(true){
if((i__6153__auto___8685 < len__6152__auto___8684)){
args__6159__auto__.push((arguments[i__6153__auto___8685]));

var G__8686 = (i__6153__auto___8685 + (1));
i__6153__auto___8685 = G__8686;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__8682){
var vec__8683 = p__8682;
var opts = cljs.core.nth.call(null,vec__8683,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__8683,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__8683,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__8683,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__8683,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq8680){
var G__8681 = cljs.core.first.call(null,seq8680);
var seq8680__$1 = cljs.core.next.call(null,seq8680);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__8681,seq8680__$1);
});
