...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__15574,opts){
var map__15575 = p__15574;
var map__15575__$1 = ((((!((map__15575 == null)))?((((map__15575.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15575.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15575):map__15575);
var files = cljs.core.get.call(null,map__15575__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6152__auto___15581 = arguments.length;
var i__6153__auto___15582 = (0);
while(true){
if((i__6153__auto___15582 < len__6152__auto___15581)){
args__6159__auto__.push((arguments[i__6153__auto___15582]));

var G__15583 = (i__6153__auto___15582 + (1));
i__6153__auto___15582 = G__15583;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__15579){
var vec__15580 = p__15579;
var opts = cljs.core.nth.call(null,vec__15580,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__15580,opts){
return (function (evt){
...
});})(conn,vec__15580,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__15580,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__15580,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__15580,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq15577){
var G__15578 = cljs.core.first.call(null,seq15577);
var seq15577__$1 = cljs.core.next.call(null,seq15577);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__15578,seq15577__$1);
});
