...
var attr = cljs.core.nth.call(null,vec__15733,(0),null);
...
var args15734 = [];
var len__6152__auto___15737 = arguments.length;
var i__6153__auto___15738 = (0);
while(true){
if((i__6153__auto___15738 < len__6152__auto___15737)){
args15734.push((arguments[i__6153__auto___15738]));

var G__15739 = (i__6153__auto___15738 + (1));
i__6153__auto___15738 = G__15739;
continue;
} else {
}
break;
...
var len__6152__auto___15742 = arguments.length;
var i__6153__auto___15743 = (0);
while(true){
if((i__6153__auto___15743 < len__6152__auto___15742)){
args__6159__auto__.push((arguments[i__6153__auto___15743]));

var G__15744 = (i__6153__auto___15743 + (1));
i__6153__auto___15743 = G__15744;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq15741){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq15741));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__15745){
var map__15749 = p__15745;
var map__15749__$1 = ((((!((map__15749 == null)))?((((map__15749.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15749.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15749):map__15749);
var data = map__15749__$1;
var message = cljs.core.get.call(null,map__15749__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__15749__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__15749__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__15751 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__15751,goog.events.EventType.CLICK,((function (G__15751,map__15749,map__15749__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__15751,map__15749,map__15749__$1,data,message,line,file))
);

return G__15751;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__15752){
var map__15756 = p__15752;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__15759){
...
var messages = map__15763__$1;
var warnings = cljs.core.get.call(null,map__15763__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__15763__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__15765 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__15765,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__15765,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__15766){
var map__15769 = p__15766;
var map__15769__$1 = ((((!((map__15769 == null)))?((((map__15769.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15769.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15769):map__15769);
var messages = map__15769__$1;
var warnings = cljs.core.get.call(null,map__15769__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__15769__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__15769,map__15769__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__15769,map__15769__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__15769,map__15769__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__15769,map__15769__$1,messages,warnings,exception))
;
