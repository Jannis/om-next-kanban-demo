...
return (function (p__8606){
var vec__8607 = p__8606;
var attr = cljs.core.nth.call(null,vec__8607,(0),null);
var v = cljs.core.nth.call(null,vec__8607,(1),null);
...
var args8608 = [];
var len__6152__auto___8611 = arguments.length;
var i__6153__auto___8612 = (0);
while(true){
if((i__6153__auto___8612 < len__6152__auto___8611)){
args8608.push((arguments[i__6153__auto___8612]));

var G__8613 = (i__6153__auto___8612 + (1));
i__6153__auto___8612 = G__8613;
continue;
} else {
}
break;
...
var len__6152__auto___8616 = arguments.length;
var i__6153__auto___8617 = (0);
while(true){
if((i__6153__auto___8617 < len__6152__auto___8616)){
args__6159__auto__.push((arguments[i__6153__auto___8617]));

var G__8618 = (i__6153__auto___8617 + (1));
i__6153__auto___8617 = G__8618;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq8615){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8615));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__8619){
var map__8623 = p__8619;
...
var data = map__8623__$1;
var message = cljs.core.get.call(null,map__8623__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__8623__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__8623__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__8625 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__8625,goog.events.EventType.CLICK,((function (G__8625,map__8623,map__8623__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__8625,map__8623,map__8623__$1,data,message,line,file))
);

return G__8625;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__8626){
var map__8630 = p__8626;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__8633){
var map__8637 = p__8633;
...
var messages = map__8637__$1;
var warnings = cljs.core.get.call(null,map__8637__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8637__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__8639 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__8639,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__8639,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__8640){
var map__8643 = p__8640;
...
var messages = map__8643__$1;
var warnings = cljs.core.get.call(null,map__8643__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8643__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__8643,map__8643__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__8643,map__8643__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__8643,map__8643__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__8643,map__8643__$1,messages,warnings,exception))
;
