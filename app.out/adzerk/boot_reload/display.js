...
var attr = cljs.core.nth.call(null,vec__8644,(0),null);
...
var args8645 = [];
var len__6152__auto___8648 = arguments.length;
var i__6153__auto___8649 = (0);
while(true){
if((i__6153__auto___8649 < len__6152__auto___8648)){
args8645.push((arguments[i__6153__auto___8649]));

var G__8650 = (i__6153__auto___8649 + (1));
i__6153__auto___8649 = G__8650;
continue;
} else {
}
break;
...
var len__6152__auto___8653 = arguments.length;
var i__6153__auto___8654 = (0);
while(true){
if((i__6153__auto___8654 < len__6152__auto___8653)){
args__6159__auto__.push((arguments[i__6153__auto___8654]));

var G__8655 = (i__6153__auto___8654 + (1));
i__6153__auto___8654 = G__8655;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq8652){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8652));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__8656){
var map__8660 = p__8656;
...
var data = map__8660__$1;
var message = cljs.core.get.call(null,map__8660__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__8660__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__8660__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__8662 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__8662,goog.events.EventType.CLICK,((function (G__8662,map__8660,map__8660__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__8662,map__8660,map__8660__$1,data,message,line,file))
);

return G__8662;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__8663){
var map__8667 = p__8663;
var map__8667__$1 = ((((!((map__8667 == null)))?((((map__8667.cljs$lang$protocol_mask$partition0$ & (64))) || (map__8667.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8667):map__8667);
var data = map__8667__$1;
var message = cljs.core.get.call(null,map__8667__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__8667__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__8667__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__8669 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str("at line "),cljs.core.str(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__8669,goog.events.EventType.CLICK,((function (G__8669,map__8667,map__8667__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__8669,map__8667,map__8667__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__8670){
var map__8674 = p__8670;
var map__8674__$1 = ((((!((map__8674 == null)))?((((map__8674.cljs$lang$protocol_mask$partition0$ & (64))) || (map__8674.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8674):map__8674);
var messages = map__8674__$1;
var warnings = cljs.core.get.call(null,map__8674__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8674__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__8676 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__8676,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__8676,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__8677){
...
var messages = map__8680__$1;
var warnings = cljs.core.get.call(null,map__8680__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8680__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__8680,map__8680__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__8680,map__8680__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__8680,map__8680__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__8680,map__8680__$1,messages,warnings,exception))
;
