...
return (function (p__15806){
var vec__15807 = p__15806;
var attr = cljs.core.nth.call(null,vec__15807,(0),null);
var v = cljs.core.nth.call(null,vec__15807,(1),null);
...
var args15808 = [];
var len__6152__auto___15811 = arguments.length;
var i__6153__auto___15812 = (0);
while(true){
if((i__6153__auto___15812 < len__6152__auto___15811)){
args15808.push((arguments[i__6153__auto___15812]));

var G__15813 = (i__6153__auto___15812 + (1));
i__6153__auto___15812 = G__15813;
continue;
} else {
}
break;
...
var len__6152__auto___15816 = arguments.length;
var i__6153__auto___15817 = (0);
while(true){
if((i__6153__auto___15817 < len__6152__auto___15816)){
args__6159__auto__.push((arguments[i__6153__auto___15817]));

var G__15818 = (i__6153__auto___15817 + (1));
i__6153__auto___15817 = G__15818;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq15815){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq15815));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__15819){
var map__15823 = p__15819;
...
var data = map__15823__$1;
var message = cljs.core.get.call(null,map__15823__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__15823__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__15823__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__15825 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__15825,goog.events.EventType.CLICK,((function (G__15825,map__15823,map__15823__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__15825,map__15823,map__15823__$1,data,message,line,file))
);

return G__15825;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__15826){
var map__15830 = p__15826;
var map__15830__$1 = ((((!((map__15830 == null)))?((((map__15830.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15830.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15830):map__15830);
var data = map__15830__$1;
var message = cljs.core.get.call(null,map__15830__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__15830__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__15830__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__15832 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str("at line "),cljs.core.str(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__15832,goog.events.EventType.CLICK,((function (G__15832,map__15830,map__15830__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__15832,map__15830,map__15830__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__15833){
var map__15837 = p__15833;
var map__15837__$1 = ((((!((map__15837 == null)))?((((map__15837.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15837.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15837):map__15837);
var messages = map__15837__$1;
var warnings = cljs.core.get.call(null,map__15837__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__15837__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__15839 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__15839,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__15839,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__15840){
var map__15843 = p__15840;
...
var messages = map__15843__$1;
var warnings = cljs.core.get.call(null,map__15843__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__15843__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__15843,map__15843__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__15843,map__15843__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__15843,map__15843__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__15843,map__15843__$1,messages,warnings,exception))
;
