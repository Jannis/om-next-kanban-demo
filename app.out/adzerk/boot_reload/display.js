...
var attr = cljs.core.nth.call(null,vec__8611,(0),null);
...
args8612.push((arguments[i__6153__auto___8616]));
...
var len__6152__auto___8620 = arguments.length;
var i__6153__auto___8621 = (0);
while(true){
if((i__6153__auto___8621 < len__6152__auto___8620)){
args__6159__auto__.push((arguments[i__6153__auto___8621]));

var G__8622 = (i__6153__auto___8621 + (1));
i__6153__auto___8621 = G__8622;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq8619){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8619));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__8623){
var map__8627 = p__8623;
var map__8627__$1 = ((((!((map__8627 == null)))?((((map__8627.cljs$lang$protocol_mask$partition0$ & (64))) || (map__8627.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8627):map__8627);
var data = map__8627__$1;
var message = cljs.core.get.call(null,map__8627__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__8627__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__8627__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__8629 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__8629,goog.events.EventType.CLICK,((function (G__8629,map__8627,map__8627__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__8629,map__8627,map__8627__$1,data,message,line,file))
);

return G__8629;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__8630){
var map__8634 = p__8630;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__8637){
var map__8641 = p__8637;
...
var messages = map__8641__$1;
var warnings = cljs.core.get.call(null,map__8641__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8641__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__8643 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__8643,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__8643,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__8644){
var map__8647 = p__8644;
var map__8647__$1 = ((((!((map__8647 == null)))?((((map__8647.cljs$lang$protocol_mask$partition0$ & (64))) || (map__8647.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8647):map__8647);
var messages = map__8647__$1;
var warnings = cljs.core.get.call(null,map__8647__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8647__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__8647,map__8647__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__8647,map__8647__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__8647,map__8647__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__8647,map__8647__$1,messages,warnings,exception))
;
