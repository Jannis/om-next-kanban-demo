...
var attr = cljs.core.nth.call(null,vec__8773,(0),null);
...
var args8774 = [];
var len__6152__auto___8777 = arguments.length;
var i__6153__auto___8778 = (0);
while(true){
if((i__6153__auto___8778 < len__6152__auto___8777)){
args8774.push((arguments[i__6153__auto___8778]));

var G__8779 = (i__6153__auto___8778 + (1));
i__6153__auto___8778 = G__8779;
continue;
} else {
}
break;
...
var len__6152__auto___8782 = arguments.length;
var i__6153__auto___8783 = (0);
while(true){
if((i__6153__auto___8783 < len__6152__auto___8782)){
args__6159__auto__.push((arguments[i__6153__auto___8783]));

var G__8784 = (i__6153__auto___8783 + (1));
i__6153__auto___8783 = G__8784;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq8781){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8781));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__8785){
var map__8789 = p__8785;
...
var G__8791 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__8791,goog.events.EventType.CLICK,((function (G__8791,map__8789,map__8789__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__8791,map__8789,map__8789__$1,data,message,line,file))
);

return G__8791;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__8792){
var map__8796 = p__8792;
var map__8796__$1 = ((((!((map__8796 == null)))?((((map__8796.cljs$lang$protocol_mask$partition0$ & (64))) || (map__8796.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8796):map__8796);
var data = map__8796__$1;
var message = cljs.core.get.call(null,map__8796__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__8796__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__8796__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__8798 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str("at line "),cljs.core.str(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__8798,goog.events.EventType.CLICK,((function (G__8798,map__8796,map__8796__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__8798,map__8796,map__8796__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__8799){
var map__8803 = p__8799;
...
var messages = map__8803__$1;
var warnings = cljs.core.get.call(null,map__8803__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8803__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__8805 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__8805,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__8805,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__8806){
var map__8809 = p__8806;
...
var messages = map__8809__$1;
var warnings = cljs.core.get.call(null,map__8809__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8809__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__8809,map__8809__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__8809,map__8809__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__8809,map__8809__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__8809,map__8809__$1,messages,warnings,exception))
;
...
}catch (e8812){if((e8812 instanceof Error)){
var __8813 = e8812;
} else {
throw e8812;
