...
args__6159__auto__.push((arguments[i__6153__auto___17348]));
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq17346){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq17346));
});
/**
...
var vec__17351 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__17351,(0),null);
var words = cljs.core.nthnext.call(null,vec__17351,(1));
...
var G__17353 = clojure.set.rename_keys.call(null,m,kmap);
var G__17353__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__17353,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__17353);
return G__17353__$1;
} else {
return m;
}
...
args__6159__auto__.push((arguments[i__6153__auto___17357]));
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__17354_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__17354_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__17354_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__17354_SHARP_)){
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq17355){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq17355));
});
/**
...
var vec__17362 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__17362,(0),null);
var names = cljs.core.nth.call(null,vec__17362,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__17362,tag_name,names){
return (function (p1__17359_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__17359_SHARP_));
});})(matches,vec__17362,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__17362,tag_name,names){
return (function (p1__17360_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__17360_SHARP_));
});})(matches,vec__17362,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__17363){
var vec__17366 = p__17363;
var tag = cljs.core.nth.call(null,vec__17366,(0),null);
var content = cljs.core.nthnext.call(null,vec__17366,(1));
...
var vec__17367 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__17367,(0),null);
var id = cljs.core.nth.call(null,vec__17367,(1),null);
var class$ = cljs.core.nth.call(null,vec__17367,(2),null);
