...
var len__6152__auto___17365 = arguments.length;
var i__6153__auto___17366 = (0);
while(true){
if((i__6153__auto___17366 < len__6152__auto___17365)){
args__6159__auto__.push((arguments[i__6153__auto___17366]));

var G__17367 = (i__6153__auto___17366 + (1));
i__6153__auto___17366 = G__17367;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq17364){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq17364));
});
/**
...
var vec__17369 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__17369,(0),null);
var words = cljs.core.nthnext.call(null,vec__17369,(1));
...
var G__17371 = clojure.set.rename_keys.call(null,m,kmap);
var G__17371__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__17371,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__17371);
return G__17371__$1;
} else {
return m;
}
...
args__6159__auto__.push((arguments[i__6153__auto___17375]));
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__17372_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__17372_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__17372_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__17372_SHARP_)){
return p1__17372_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__17372_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq17373){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq17373));
});
/**
...
var tag_name = cljs.core.nth.call(null,vec__17380,(0),null);
var names = cljs.core.nth.call(null,vec__17380,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__17380,tag_name,names){
return (function (p1__17377_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__17377_SHARP_));
});})(matches,vec__17380,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__17380,tag_name,names){
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__17381){
var vec__17384 = p__17381;
var tag = cljs.core.nth.call(null,vec__17384,(0),null);
var content = cljs.core.nthnext.call(null,vec__17384,(1));
...
var vec__17385 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__17385,(0),null);
var id = cljs.core.nth.call(null,vec__17385,(1),null);
var class$ = cljs.core.nth.call(null,vec__17385,(2),null);
